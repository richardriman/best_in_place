...
BestInPlaceEditor.prototype = {
  ...
  initOptions : function() {
    ...
    self.element.parents().each(function() {
      ...
      self.textareaAutosize  = self.textareaAutosize  || $parent.attr("data-autosize");
    });
    ...
    self.textareaAutosize  = self.element.attr("data-autosize")            || self.textareaAutosize  || false;
